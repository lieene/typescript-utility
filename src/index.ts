...
export type Alter<T extends object, U extends object> = Exclude<T, U> & Extract<U, T>;
export type Extend<T extends object, U extends object> = T & Exclude<U, T>;
export type Override<T extends object, U extends object> = Exclude<T, U> & U;

export type AlterOver<T extends object, U extends object, X extends object> = Alter<T, Exclude<U, X>>;
export type ExtendOver<T extends object, U extends object, X extends object> = Extend<T, Exclude<U, X>>;
export type OverrideOver<T extends object, U extends object, X extends object> = Override<T, Exclude<U, X>>;

export type AlterLike<T extends object, U extends object, X extends object> = Alter<T, Extract<U, X>>;
export type ExtendLike<T extends object, U extends object, X extends object> = Extend<T, Extract<U, X>>;
export type OverrideLike<T extends object, U extends object, X extends object> = Override<T, Extract<U, X>>;
